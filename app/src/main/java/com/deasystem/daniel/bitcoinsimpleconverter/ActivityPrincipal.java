    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if(id == R.id.nav_inicial){
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.frame_layout, new FragMain()).commit();
        } else if (id == R.id.nav_calculadora_livre) {
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.frame_layout, new FragCalculadora()).commit();
        } else if (id == R.id.nav_blockchain) {
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.frame_layout, new FragBlockChain()).commit();
        } else if (id == R.id.nav_bitcoin) {
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.frame_layout, new FragBitcoin()).commit();
        } else if (id == R.id.nav_lucro) {
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.frame_layout, new FragLucro()).commit();
        } else if (id == R.id.nav_wallet) {
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.frame_layout, new FragWallet()).commit();
        }
